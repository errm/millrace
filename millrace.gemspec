...
require_relative "lib/millrace/version"

Gem::Specification.new do |spec|
  spec.name = "millrace"
  spec.version = Millrace::VERSION
  spec.authors = ["Ed Robinson"]
  spec.email = ["edward-robinson@cookpad.com"]

  spec.summary = "Rate limiting on rails"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/errm/millrace"
  spec.metadata["changelog_uri"] = "https://github.com/errm/millrace/blob/main/CHANGELOG.md"
